...
?>
	<head>
		...
		function cargar() {
			...
			obXHR.open("GET", "tabla.php?dni="+$("#dni").attr("value"));
...
<body bgcolor="gray">
	<div id="recuadro">
		<div style="margin-left:10px;">
			<center>
				<br>
				<span style="color:black;font-size:12px;"><strong>CONSULTA DE TURNOS OTORGADOS HIST&Oacute;RICAMENTE:</strong></span>
				<br>
				<table><tr>
					<div style="width:100px;">
						<td>Ingrese el DNI: <input style="text-align:center;width:120px;" id="dni" name="dni" value="" type="text"></td>
