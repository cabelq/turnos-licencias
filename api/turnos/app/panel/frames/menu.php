...
INI;
	...
	$menu_usuarios = <<<INI
		<div id="menu_barra_herramientas"  >
			<div id="individual" style="width:100px;font-size:15px;">Administrador:</div>
			...
			<div id="individual"><A href="../turnos/abm/turnos_panel.php" target="principal"><input Title="Administracion de Turnos" type=image src="../images/menu/turnos.png" width="19px" height="19px"></a></div>
		</div>
INI;
