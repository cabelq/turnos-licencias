...
?>
	<head>
		...
		function cargar() {
			...
			obXHR.open("GET", "tabla.php?anio="+$("#anio").attr("value"));
...
<body bgcolor="gray">
	<div id="recuadro">
		<div style="margin-left:10px;">
			<center>
				<br>
				<span style="color:black;font-size:12px;"><strong>ADMINISTRADOR DE FERIADOS:</strong></span>
				<br>
				<table><tr>
					<div style="width:100px;">
						<td>
							<div style="padding-left:10px;padding-top:3px;margin-top:-4px;width:110px;background:#D5D5D5;border:1px solid black;height:30px;">
								<Button style="height:26px;width:100px;background:#EEE;" class="boton" onClick="popupSizablePosition('./feriado_nuevo.php',550,200,220,60)" name="nuevo">Nuevo Feriado+</button>
							</div>
						</td>
						<td>Ingrese el a&ntilde;o: <input style="text-align:center;width:120px;" id="anio" name="anio" value="<?php echo date("Y");?>" type="text"></td>
